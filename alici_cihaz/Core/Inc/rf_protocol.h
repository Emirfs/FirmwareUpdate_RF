...
// =========================================================================
// Bu dosya alıcı ve gönderici tarafında ortak kullanılır.
// Ayrıntılı tanımlar rf_bootloader.h dosyasındadır.
// =========================================================================
...
#define RF_CHUNKS_PER_PACKET 4 // 148 byte → 4 parça (48+48+48+4)
