/*
 * si4432.h — Si4432 RF Modul Surucusu Arayuzu (Gonderici)
 *
 ...
 *   2. SI4432_SendPacket(data, len)           — TX
 *   3. SI4432_StartRx()                       — RX moduna gec
 *   4. SI4432_CheckRx(buf) != 0 ise paket var — RX polling
 */
#ifndef __SI4432_H__
#define __SI4432_H__
...
/* Chip baslatma — SDN/SDI/SPI ve tum register ayarlari */
void SI4432_Init(void);

/* Dusuk seviye SPI register erisimi */
void SI4432_WriteReg(uint8_t reg, uint8_t value);
uint8_t SI4432_ReadReg(uint8_t reg);

/* Paketi gonder ve tamamlanana kadar bekle (bloke) */
void SI4432_SendPacket(const uint8_t *data, uint8_t len);

/* RX moduna gec — SI4432_CheckRx ile polling yapilmali */
